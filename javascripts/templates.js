window.require.register("templates", function(require, module) {angular.module('templates-main', ['templates/characters/details.html', 'templates/characters/list.html']);
