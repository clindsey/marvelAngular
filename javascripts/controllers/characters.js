window.require.register("controllers/characters", function(require, module) {var characterControllers, config, onCharacterClick, onRouteUpdate, pageChanged, search, setInitialState, showPage;
